 ...
 * @since 1.0.0
 */
class AUTRICS_Icon_Controler extends Elementor\Base_Data_Control {
	...
	public static function get_icons() {
		...
		$icons = array(
                  ...
                  'icon icon-services_icon_1' => 'icon icon-services_icon_1',
                  'icon icon-services_icon_2' => 'icon icon-services_icon_2',
                  'icon icon-services_icon_3' => 'icon icon-services_icon_3',
                  'icon icon-services_icon_4' => 'icon icon-services_icon_4',
                  'icon icon-services_icon_5' => 'icon icon-services_icon_5',
                  'icon icon-services_icon_6' => 'icon icon-services_icon_6',
                  ...
                  'icon icon-history1' => 'icon icon-history1',
                  ...
                  'icon icon-pricing1Asset1' => 'icon icon-pricing1Asset1',
                  'icon icon-pricing2Asset2' => 'icon icon-pricing2Asset2',
                  'icon icon-pricing3Asset3' => 'icon icon-pricing3Asset3',
                  'icon icon-ring1Asset1' => 'icon icon-ring1Asset1',
                  'icon icon-ring2Asset1' => 'icon icon-ring2Asset1',
                  ...
                  'icon icon-ring3Asset2' => 'icon icon-ring3Asset2',
                  'icon icon-ring4Asset3' => 'icon icon-ring4Asset3',
                  'icon icon-speaker' => 'icon icon-speaker',
                  'icon icon-air_conditioning' => 'icon icon-air_conditioning',
                  'icon icon-bag' => 'icon icon-bag',
                  'icon icon-brake' => 'icon icon-brake',
                  'icon icon-car_1' => 'icon icon-car_1',
                  'icon icon-car_2' => 'icon icon-car_2',
                  'icon icon-cheackmark' => 'icon icon-cheackmark',
                  'icon icon-client' => 'icon icon-client',
                  'icon icon-comment' => 'icon icon-comment',
                  'icon icon-computer' => 'icon icon-computer',
                  'icon icon-customer' => 'icon icon-customer',
                  'icon icon-download' => 'icon icon-download',
                  'icon icon-engine' => 'icon icon-engine',
                  'icon icon-fast' => 'icon icon-fast',
                  'icon icon-folder' => 'icon icon-folder',
                  'icon icon-history' => 'icon icon-history',
                  'icon icon-mechanic' => 'icon icon-mechanic',
                  'icon icon-mission' => 'icon icon-mission',
                  'icon icon-objective' => 'icon icon-objective',
                  'icon icon-oil' => 'icon icon-oil',
                  'icon icon-percentage' => 'icon icon-percentage',
                  'icon icon-performance' => 'icon icon-performance',
                  'icon icon-play' => 'icon icon-play',
                  'icon icon-price' => 'icon icon-price',
                  'icon icon-pricetag' => 'icon icon-pricetag',
                  'icon icon-repair' => 'icon icon-repair',
                  'icon icon-request_quote' => 'icon icon-request_quote',
                  'icon icon-solution' => 'icon icon-solution',
                  'icon icon-star' => 'icon icon-star',
                  'icon icon-steering' => 'icon icon-steering',
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				...
				<select class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php esc_attr_e( 'Select Icon', 'autrics' ); ?>">

					<option value=""><?php esc_html_e( 'Select Icon', 'autrics' ); ?></option>
