...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = AUTRICS_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( AUTRICS_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'autrics' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'autrics' ),
					'hand'				 => esc_html__( 'Hand Icons', 'autrics' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'autrics' ),
					'gender'			 => esc_html__( 'Gender Icons', 'autrics' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'autrics' ),
					'payment'			 => esc_html__( 'Payment Icons', 'autrics' ),
					'currency'			 => esc_html__( 'Currency Icons', 'autrics' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'autrics' ),
					'directional'		 => esc_html__( 'Directional Icons', 'autrics' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'autrics' ),
					'brand'				 => esc_html__( 'Brand Icons', 'autrics' ),
					'medical'			 => esc_html__( 'Medical Icons', 'autrics' ),
					'automobil-icons'	 => esc_html__( 'Autrics Icons', 'autrics' ),
				),
				'icons'				 => array(
					...
					//automobil Icons
					'icon icon-home' => array('group' => 'automobil-icons'),
					'icon icon-apartment' => array('group' => 'automobil-icons'),
					'icon icon-pencil' => array('group' => 'automobil-icons'),
					'icon icon-magic-wand' => array('group' => 'automobil-icons'),
					'icon icon-drop' => array('group' => 'automobil-icons'),
					'icon icon-lighter' => array('group' => 'automobil-icons'),
					'icon icon-poop' => array('group' => 'automobil-icons'),
					'icon icon-sun' => array('group' => 'automobil-icons'),
					'icon icon-moon' => array('group' => 'automobil-icons'),
					'icon icon-cloud' => array('group' => 'automobil-icons'),
					'icon icon-cloud-upload' => array('group' => 'automobil-icons'),
					'icon icon-cloud-download' => array('group' => 'automobil-icons'),
					'icon icon-cloud-sync' => array('group' => 'automobil-icons'),
					'icon icon-cloud-check' => array('group' => 'automobil-icons'),
					'icon icon-database' => array('group' => 'automobil-icons'),
					'icon icon-lock' => array('group' => 'automobil-icons'),
					'icon icon-cog' => array('group' => 'automobil-icons'),
					'icon icon-trash' => array('group' => 'automobil-icons'),
					'icon icon-dice' => array('group' => 'automobil-icons'),
					'icon icon-heart' => array('group' => 'automobil-icons'),
					'icon icon-star1' => array('group' => 'automobil-icons'),
					'icon icon-star-half' => array('group' => 'automobil-icons'),
					'icon icon-star-empty' => array('group' => 'automobil-icons'),
					'icon icon-flag' => array('group' => 'automobil-icons'),
					'icon icon-envelope' => array('group' => 'automobil-icons'),
					'icon icon-paperclip' => array('group' => 'automobil-icons'),
					'icon icon-inbox' => array('group' => 'automobil-icons'),
					'icon icon-eye' => array('group' => 'automobil-icons'),
					'icon icon-printer' => array('group' => 'automobil-icons'),
					'icon icon-file-empty' => array('group' => 'automobil-icons'),
					'icon icon-file-add' => array('group' => 'automobil-icons'),
					'icon icon-enter' => array('group' => 'automobil-icons'),
					'icon icon-exit' => array('group' => 'automobil-icons'),
					'icon icon-graduation-hat' => array('group' => 'automobil-icons'),
					'icon icon-license' => array('group' => 'automobil-icons'),
					'icon icon-music-note' => array('group' => 'automobil-icons'),
					'icon icon-film-play' => array('group' => 'automobil-icons'),
					'icon icon-camera-video' => array('group' => 'automobil-icons'),
					'icon icon-camera' => array('group' => 'automobil-icons'),
					'icon icon-picture' => array('group' => 'automobil-icons'),
					'icon icon-book' => array('group' => 'automobil-icons'),
					'icon icon-bookmark' => array('group' => 'automobil-icons'),
					'icon icon-user' => array('group' => 'automobil-icons'),
					'icon icon-users' => array('group' => 'automobil-icons'),
					'icon icon-shirt' => array('group' => 'automobil-icons'),
					'icon icon-store' => array('group' => 'automobil-icons'),
					'icon icon-cart' => array('group' => 'automobil-icons'),
					'icon icon-tag1' => array('group' => 'automobil-icons'),
					'icon icon-phone-handset' => array('group' => 'automobil-icons'),
					'icon icon-phone' => array('group' => 'automobil-icons'),
					'icon icon-pushpin' => array('group' => 'automobil-icons'),
					'icon icon-map-marker' => array('group' => 'automobil-icons'),
					'icon icon-map' => array('group' => 'automobil-icons'),
					'icon icon-location' => array('group' => 'automobil-icons'),
					'icon icon-calendar-full' => array('group' => 'automobil-icons'),
					'icon icon-keyboard' => array('group' => 'automobil-icons'),
					'icon icon-spell-check' => array('group' => 'automobil-icons'),
					'icon icon-screen' => array('group' => 'automobil-icons'),
					'icon icon-smartphone' => array('group' => 'automobil-icons'),
					'icon icon-tablet' => array('group' => 'automobil-icons'),
					'icon icon-laptop' => array('group' => 'automobil-icons'),
					'icon icon-laptop-phone' => array('group' => 'automobil-icons'),
					'icon icon-power-switch' => array('group' => 'automobil-icons'),
					'icon icon-bubble' => array('group' => 'automobil-icons'),
					'icon icon-heart-pulse' => array('group' => 'automobil-icons'),
					'icon icon-construction' => array('group' => 'automobil-icons'),
					'icon icon-pie-chart' => array('group' => 'automobil-icons'),
					'icon icon-chart-bars' => array('group' => 'automobil-icons'),
					'icon icon-gift' => array('group' => 'automobil-icons'),
					'icon icon-diamond' => array('group' => 'automobil-icons'),
					'icon icon-dinner' => array('group' => 'automobil-icons'),
					'icon icon-coffee-cup' => array('group' => 'automobil-icons'),
					'icon icon-leaf' => array('group' => 'automobil-icons'),
					'icon icon-paw' => array('group' => 'automobil-icons'),
					'icon icon-rocket' => array('group' => 'automobil-icons'),
					'icon icon-briefcase' => array('group' => 'automobil-icons'),
					'icon icon-bus' => array('group' => 'automobil-icons'),
					'icon icon-car' => array('group' => 'automobil-icons'),
					'icon icon-train' => array('group' => 'automobil-icons'),
					'icon icon-bicycle' => array('group' => 'automobil-icons'),
					'icon icon-wheelchair' => array('group' => 'automobil-icons'),
					'icon icon-select' => array('group' => 'automobil-icons'),
					'icon icon-earth' => array('group' => 'automobil-icons'),
					'icon icon-smile' => array('group' => 'automobil-icons'),
					'icon icon-sad' => array('group' => 'automobil-icons'),
					'icon icon-neutral' => array('group' => 'automobil-icons'),
					'icon icon-mustache' => array('group' => 'automobil-icons'),
					'icon icon-alarm' => array('group' => 'automobil-icons'),
					'icon icon-bullhorn' => array('group' => 'automobil-icons'),
					'icon icon-volume-high' => array('group' => 'automobil-icons'),
					'icon icon-volume-medium' => array('group' => 'automobil-icons'),
					'icon icon-volume-low' => array('group' => 'automobil-icons'),
					'icon icon-volume' => array('group' => 'automobil-icons'),
					'icon icon-mic' => array('group' => 'automobil-icons'),
					'icon icon-hourglass' => array('group' => 'automobil-icons'),
					'icon icon-undo' => array('group' => 'automobil-icons'),
					'icon icon-redo' => array('group' => 'automobil-icons'),
					'icon icon-sync' => array('group' => 'automobil-icons'),
					'icon icon-history1' => array('group' => 'automobil-icons'),
					'icon icon-clock' => array('group' => 'automobil-icons'),
					'icon icon-download1' => array('group' => 'automobil-icons'),
					'icon icon-upload' => array('group' => 'automobil-icons'),
					'icon icon-enter-down' => array('group' => 'automobil-icons'),
					'icon icon-exit-up' => array('group' => 'automobil-icons'),
					'icon icon-bug' => array('group' => 'automobil-icons'),
					'icon icon-code' => array('group' => 'automobil-icons'),
					'icon icon-link' => array('group' => 'automobil-icons'),
					'icon icon-unlink' => array('group' => 'automobil-icons'),
					'icon icon-thumbs-up' => array('group' => 'automobil-icons'),
					'icon icon-thumbs-down' => array('group' => 'automobil-icons'),
					'icon icon-magnifier' => array('group' => 'automobil-icons'),
					'icon icon-cross' => array('group' => 'automobil-icons'),
					'icon icon-menu' => array('group' => 'automobil-icons'),
					'icon icon-list' => array('group' => 'automobil-icons'),
					'icon icon-chevron-up' => array('group' => 'automobil-icons'),
					'icon icon-chevron-down' => array('group' => 'automobil-icons'),
					'icon icon-chevron-left' => array('group' => 'automobil-icons'),
					'icon icon-chevron-right' => array('group' => 'automobil-icons'),
					'icon icon-arrow-up' => array('group' => 'automobil-icons'),
					'icon icon-arrow-down' => array('group' => 'automobil-icons'),
					'icon icon-arrow-left' => array('group' => 'automobil-icons'),
					'icon icon-arrow-right' => array('group' => 'automobil-icons'),
					'icon icon-move' => array('group' => 'automobil-icons'),
					'icon icon-warning' => array('group' => 'automobil-icons'),
					'icon icon-question-circle' => array('group' => 'automobil-icons'),
					'icon icon-menu-circle' => array('group' => 'automobil-icons'),
					'icon icon-checkmark-circle' => array('group' => 'automobil-icons'),
					'icon icon-cross-circle' => array('group' => 'automobil-icons'),
					'icon icon-plus-circle' => array('group' => 'automobil-icons'),
					'icon icon-circle-minus' => array('group' => 'automobil-icons'),
					'icon icon-arrow-up-circle' => array('group' => 'automobil-icons'),
					'icon icon-arrow-down-circle' => array('group' => 'automobil-icons'),
					'icon icon-arrow-left-circle' => array('group' => 'automobil-icons'),
					'icon icon-arrow-right-circle' => array('group' => 'automobil-icons'),
					'icon icon-chevron-up-circle' => array('group' => 'automobil-icons'),
					'icon icon-chevron-down-circle' => array('group' => 'automobil-icons'),
					'icon icon-chevron-left-circle' => array('group' => 'automobil-icons'),
					'icon icon-chevron-right-circle' => array('group' => 'automobil-icons'),
					'icon icon-crop' => array('group' => 'automobil-icons'),
					'icon icon-frame-expand' => array('group' => 'automobil-icons'),
					'icon icon-frame-contract' => array('group' => 'automobil-icons'),
					'icon icon-layers' => array('group' => 'automobil-icons'),
					'icon icon-funnel' => array('group' => 'automobil-icons'),
					'icon icon-text-format' => array('group' => 'automobil-icons'),
					'icon icon-text-size' => array('group' => 'automobil-icons'),
					'icon icon-bold' => array('group' => 'automobil-icons'),
					'icon icon-italic' => array('group' => 'automobil-icons'),
					'icon icon-underline' => array('group' => 'automobil-icons'),
					'icon icon-strikethrough' => array('group' => 'automobil-icons'),
					'icon icon-highlight' => array('group' => 'automobil-icons'),
					'icon icon-text-align-left' => array('group' => 'automobil-icons'),
					'icon icon-text-align-center' => array('group' => 'automobil-icons'),
					'icon icon-text-align-right' => array('group' => 'automobil-icons'),
					'icon icon-text-align-justify' => array('group' => 'automobil-icons'),
					'icon icon-line-spacing' => array('group' => 'automobil-icons'),
					'icon icon-indent-increase' => array('group' => 'automobil-icons'),
					'icon icon-indent-decrease' => array('group' => 'automobil-icons'),
					'icon icon-page-break' => array('group' => 'automobil-icons'),
					'icon icon-hand' => array('group' => 'automobil-icons'),
					'icon icon-pointer-up' => array('group' => 'automobil-icons'),
					'icon icon-pointer-right' => array('group' => 'automobil-icons'),
					'icon icon-pointer-down' => array('group' => 'automobil-icons'),
					'icon icon-pointer-left' => array('group' => 'automobil-icons'),
					'icon icon-building' => array('group' => 'automobil-icons'),
					'icon icon-cycle' => array('group' => 'automobil-icons'),
					'icon icon-food' => array('group' => 'automobil-icons'),
					'icon icon-fun' => array('group' => 'automobil-icons'),
					'icon icon-hotel' => array('group' => 'automobil-icons'),
					'icon icon-marketing' => array('group' => 'automobil-icons'),
					'icon icon-Monetizing' => array('group' => 'automobil-icons'),
					'icon icon-netwrorking' => array('group' => 'automobil-icons'),
					'icon icon-people' => array('group' => 'automobil-icons'),
					'icon icon-planning' => array('group' => 'automobil-icons'),
					'icon icon-pricing1Asset1' => array('group' => 'automobil-icons'),
					'icon icon-pricing2Asset2' => array('group' => 'automobil-icons'),
					'icon icon-pricing3Asset3' => array('group' => 'automobil-icons'),
					'icon icon-ring1Asset1' => array('group' => 'automobil-icons'),
					'icon icon-ring2Asset1' => array('group' => 'automobil-icons'),
					'icon icon-vplay' => array('group' => 'automobil-icons'),
					'icon icon-newsletter' => array('group' => 'automobil-icons'),
					'icon icon-coins-2' => array('group' => 'automobil-icons'),
					'icon icon-commerce-2' => array('group' => 'automobil-icons'),
					'icon icon-monitor' => array('group' => 'automobil-icons'),
					'icon icon-facebook' => array('group' => 'automobil-icons'),
					'icon icon-business' => array('group' => 'automobil-icons'),
					'icon icon-graphic-2' => array('group' => 'automobil-icons'),
					'icon icon-commerce-1' => array('group' => 'automobil-icons'),
					'icon icon-like' => array('group' => 'automobil-icons'),
					'icon icon-home1' => array('group' => 'automobil-icons'),
					'icon icon-phone-call' => array('group' => 'automobil-icons'),
					'icon icon-contact' => array('group' => 'automobil-icons'),
					'icon icon-comments' => array('group' => 'automobil-icons'),
					'icon icon-cloud-computing' => array('group' => 'automobil-icons'),
					'icon icon-care' => array('group' => 'automobil-icons'),
					'icon icon-coin' => array('group' => 'automobil-icons'),
					'icon icon-donation' => array('group' => 'automobil-icons'),
					'icon icon-donation_2' => array('group' => 'automobil-icons'),
					'icon icon-heart1' => array('group' => 'automobil-icons'),
					'icon icon-dove' => array('group' => 'automobil-icons'),
					'icon icon-drop1' => array('group' => 'automobil-icons'),
					'icon icon-first-aid-kit' => array('group' => 'automobil-icons'),
					'icon icon-groceries' => array('group' => 'automobil-icons'),
					'icon icon-heartbeat' => array('group' => 'automobil-icons'),
					'icon icon-left-arrow' => array('group' => 'automobil-icons'),
					'icon icon-newspaper' => array('group' => 'automobil-icons'),
					'icon icon-open-book' => array('group' => 'automobil-icons'),
					'icon icon-down-arrow' => array('group' => 'automobil-icons'),
					'icon icon-planet-earth' => array('group' => 'automobil-icons'),
					'icon icon-plus-button' => array('group' => 'automobil-icons'),
					'icon icon-poor-water-supply' => array('group' => 'automobil-icons'),
					'icon icon-tap-water' => array('group' => 'automobil-icons'),
					'icon icon-support' => array('group' => 'automobil-icons'),
					'icon icon-sweater' => array('group' => 'automobil-icons'),
					'icon icon-doctor' => array('group' => 'automobil-icons'),
					'icon icon-team' => array('group' => 'automobil-icons'),
					'icon icon-group' => array('group' => 'automobil-icons'),
					'icon icon-family' => array('group' => 'automobil-icons'),
					'icon icon-children' => array('group' => 'automobil-icons'),
					'icon icon-team_2' => array('group' => 'automobil-icons'),
					'icon icon-telemarketer' => array('group' => 'automobil-icons'),
					'icon icon-water' => array('group' => 'automobil-icons'),
					'icon icon-twitter' => array('group' => 'automobil-icons'),
					'icon icon-twitter1' => array('group' => 'automobil-icons'),
					'icon icon-linkedin' => array('group' => 'automobil-icons'),
					'icon icon-youtube' => array('group' => 'automobil-icons'),
					'icon icon-dribbble' => array('group' => 'automobil-icons'),
					'icon icon-pinterest' => array('group' => 'automobil-icons'),
					'icon icon-vimeo' => array('group' => 'automobil-icons'),
					'icon icon-soundcloud' => array('group' => 'automobil-icons'),
					'icon icon-youtube-v' => array('group' => 'automobil-icons'),
					'icon icon-behance' => array('group' => 'automobil-icons'),
					'icon icon-google-plus' => array('group' => 'automobil-icons'),
					'icon icon-instagram' => array('group' => 'automobil-icons'),
					'icon icon-hammer' => array('group' => 'automobil-icons'),
					'icon icon-justice-1' => array('group' => 'automobil-icons'),
					'icon icon-double-left-chevron' => array('group' => 'automobil-icons'),
					'icon icon-double-angle-pointing-to-right' => array('group' => 'automobil-icons'),
					'icon icon-arrow-point-to-down' => array('group' => 'automobil-icons'),
					'icon icon-play-button' => array('group' => 'automobil-icons'),
					'icon icon-minus' => array('group' => 'automobil-icons'),
					'icon icon-plus' => array('group' => 'automobil-icons'),
					'icon icon-tick' => array('group' => 'automobil-icons'),
					'icon icon-download-arrow' => array('group' => 'automobil-icons'),
					'icon icon-edit' => array('group' => 'automobil-icons'),
					'icon icon-reply' => array('group' => 'automobil-icons'),
					'icon icon-cogwheel-outline' => array('group' => 'automobil-icons'),
					'icon icon-symbol' => array('group' => 'automobil-icons'),
					'icon icon-calendar' => array('group' => 'automobil-icons'),
					'icon icon-shopping-cart' => array('group' => 'automobil-icons'),
					'icon icon-shopping-basket' => array('group' => 'automobil-icons'),
					'icon icon-users1' => array('group' => 'automobil-icons'),
					'icon icon-man' => array('group' => 'automobil-icons'),
					'icon icon-support1' => array('group' => 'automobil-icons'),
					'icon icon-favorites' => array('group' => 'automobil-icons'),
					'icon icon-calendar1' => array('group' => 'automobil-icons'),
					'icon icon-paper-plane' => array('group' => 'automobil-icons'),
					'icon icon-placeholder' => array('group' => 'automobil-icons'),
					'icon icon-phone-call1' => array('group' => 'automobil-icons'),
					'icon icon-contact1' => array('group' => 'automobil-icons'),
					'icon icon-email' => array('group' => 'automobil-icons'),
					'icon icon-internet' => array('group' => 'automobil-icons'),
					'icon icon-quote' => array('group' => 'automobil-icons'),
					'icon icon-line' => array('group' => 'automobil-icons'),
					'icon icon-money-3' => array('group' => 'automobil-icons'),
					'icon icon-commerce' => array('group' => 'automobil-icons'),
					'icon icon-tools' => array('group' => 'automobil-icons'),
					'icon icon-pie-chart1' => array('group' => 'automobil-icons'),
					'icon icon-diamond1' => array('group' => 'automobil-icons'),
					'icon icon-agenda' => array('group' => 'automobil-icons'),
					'icon icon-like1' => array('group' => 'automobil-icons'),
					'icon icon-justice' => array('group' => 'automobil-icons'),
					'icon icon-technology' => array('group' => 'automobil-icons'),
					'icon icon-coins-1' => array('group' => 'automobil-icons'),
					'icon icon-left-arrow1' => array('group' => 'automobil-icons'),
					'icon icon-bank' => array('group' => 'automobil-icons'),
					'icon icon-calculator' => array('group' => 'automobil-icons'),
					'icon icon-chart2' => array('group' => 'automobil-icons'),
					'icon icon-map-marker1' => array('group' => 'automobil-icons'),
					'icon icon-mutual-fund' => array('group' => 'automobil-icons'),
					'icon icon-phone1' => array('group' => 'automobil-icons'),
					'icon icon-pie-chart2' => array('group' => 'automobil-icons'),
					'icon icon-play1' => array('group' => 'automobil-icons'),
					'icon icon-savings' => array('group' => 'automobil-icons'),
					'icon icon-search' => array('group' => 'automobil-icons'),
					'icon icon-tag2' => array('group' => 'automobil-icons'),
					'icon icon-tags' => array('group' => 'automobil-icons'),
					'icon icon-loan' => array('group' => 'automobil-icons'),
					'icon icon-checked' => array('group' => 'automobil-icons'),
					'icon icon-clock1' => array('group' => 'automobil-icons'),
					'icon icon-comment1' => array('group' => 'automobil-icons'),
					'icon icon-comments1' => array('group' => 'automobil-icons'),
					'icon icon-consult' => array('group' => 'automobil-icons'),
					'icon icon-consut2' => array('group' => 'automobil-icons'),
					'icon icon-envelope1' => array('group' => 'automobil-icons'),
					'icon icon-folder1' => array('group' => 'automobil-icons'),
					'icon icon-invest' => array('group' => 'automobil-icons'),
					'icon icon-right-arrow2' => array('group' => 'automobil-icons'),
					'icon icon-quote1' => array('group' => 'automobil-icons'),
					'icon icon-deal' => array('group' => 'automobil-icons'),
					'icon icon-left-arrow2' => array('group' => 'automobil-icons'),
					'icon icon-team1' => array('group' => 'automobil-icons'),
					'icon icon-tshirt' => array('group' => 'automobil-icons'),
					'icon icon-cancel' => array('group' => 'automobil-icons'),
					'icon icon-drink' => array('group' => 'automobil-icons'),
					'icon icon-home2' => array('group' => 'automobil-icons'),
					'icon icon-music' => array('group' => 'automobil-icons'),
					'icon icon-rich' => array('group' => 'automobil-icons'),
					'icon icon-brush' => array('group' => 'automobil-icons'),
					'icon icon-opposite-way' => array('group' => 'automobil-icons'),
					'icon icon-cloud-computing1' => array('group' => 'automobil-icons'),
					'icon icon-technology-1' => array('group' => 'automobil-icons'),
					'icon icon-rotate' => array('group' => 'automobil-icons'),
					'icon icon-medical' => array('group' => 'automobil-icons'),
					'icon icon-flash-1' => array('group' => 'automobil-icons'),
					'icon icon-flash' => array('group' => 'automobil-icons'),
					'icon icon-down-arrow1' => array('group' => 'automobil-icons'),
					'icon icon-hours-support' => array('group' => 'automobil-icons'),
					'icon icon-bag1' => array('group' => 'automobil-icons'),
					'icon icon-photo-camera' => array('group' => 'automobil-icons'),
					'icon icon-search-minus' => array('group' => 'automobil-icons'),
					'icon icon-search1' => array('group' => 'automobil-icons'),
					'icon icon-down-arrow2' => array('group' => 'automobil-icons'),
					'icon icon-up-arrow' => array('group' => 'automobil-icons'),
					'icon icon-right-arrow' => array('group' => 'automobil-icons'),
					'icon icon-left-arrows' => array('group' => 'automobil-icons'),
					'icon icon-school' => array('group' => 'automobil-icons'),
					'icon icon-settings' => array('group' => 'automobil-icons'),
					'icon icon-smartphone1' => array('group' => 'automobil-icons'),
					'icon icon-technology-11' => array('group' => 'automobil-icons'),
					'icon icon-tool' => array('group' => 'automobil-icons'),
					'icon icon-business1' => array('group' => 'automobil-icons'),
					'icon icon-van-1' => array('group' => 'automobil-icons'),
					'icon icon-van' => array('group' => 'automobil-icons'),
					'icon icon-vegetables' => array('group' => 'automobil-icons'),
					'icon icon-women' => array('group' => 'automobil-icons'),
					'icon icon-vintage' => array('group' => 'automobil-icons'),
					'icon icon-up-arrow1' => array('group' => 'automobil-icons'),
					'icon icon-arrows' => array('group' => 'automobil-icons'),
					'icon icon-team2' => array('group' => 'automobil-icons'),
					'icon icon-team-1' => array('group' => 'automobil-icons'),
					'icon icon-medal' => array('group' => 'automobil-icons'),
					'icon icon-uturn' => array('group' => 'automobil-icons'),
					'icon icon-apple-1' => array('group' => 'automobil-icons'),
					'icon icon-apple' => array('group' => 'automobil-icons'),
					'icon icon-light-bulb' => array('group' => 'automobil-icons'),
					'icon icon-light-bulb-1' => array('group' => 'automobil-icons'),
					'icon icon-cogwheel' => array('group' => 'automobil-icons'),
					'icon icon-watch' => array('group' => 'automobil-icons'),
					'icon icon-star2' => array('group' => 'automobil-icons'),
					'icon icon-star-1' => array('group' => 'automobil-icons'),
					'icon icon-favorite' => array('group' => 'automobil-icons'),
					'icon icon-medical1' => array('group' => 'automobil-icons'),
					'icon icon-eye1' => array('group' => 'automobil-icons'),
					'icon icon-full-screen' => array('group' => 'automobil-icons'),
					'icon icon-shuffle-arrow' => array('group' => 'automobil-icons'),
					'icon icon-online-shopping-cart' => array('group' => 'automobil-icons'),
					'icon icon-shopping-cart1' => array('group' => 'automobil-icons'),
					'icon icon-heart-shape-outline' => array('group' => 'automobil-icons'),
					'icon icon-ring3Asset2' => array('group' => 'automobil-icons'),
					'icon icon-ring4Asset3' => array('group' => 'automobil-icons'),
					'icon icon-speaker' => array('group' => 'automobil-icons'),
					'icon icon-air_conditioning' => array('group' => 'automobil-icons'),
					'icon icon-bag' => array('group' => 'automobil-icons'),
					'icon icon-brake' => array('group' => 'automobil-icons'),
					'icon icon-car_1' => array('group' => 'automobil-icons'),
					'icon icon-car_2' => array('group' => 'automobil-icons'),
					'icon icon-cheackmark' => array('group' => 'automobil-icons'),
					'icon icon-client' => array('group' => 'automobil-icons'),
					'icon icon-comment' => array('group' => 'automobil-icons'),
					'icon icon-computer' => array('group' => 'automobil-icons'),
					'icon icon-customer' => array('group' => 'automobil-icons'),
					'icon icon-download' => array('group' => 'automobil-icons'),
					'icon icon-engine' => array('group' => 'automobil-icons'),
					'icon icon-fast' => array('group' => 'automobil-icons'),
					'icon icon-folder' => array('group' => 'automobil-icons'),
					'icon icon-history' => array('group' => 'automobil-icons'),
					'icon icon-mechanic' => array('group' => 'automobil-icons'),
					'icon icon-mission' => array('group' => 'automobil-icons'),
					'icon icon-objective' => array('group' => 'automobil-icons'),
					'icon icon-oil' => array('group' => 'automobil-icons'),
					'icon icon-percentage' => array('group' => 'automobil-icons'),
					'icon icon-performance' => array('group' => 'automobil-icons'),
					'icon icon-play' => array('group' => 'automobil-icons'),
					'icon icon-price' => array('group' => 'automobil-icons'),
					'icon icon-pricetag' => array('group' => 'automobil-icons'),
					'icon icon-repair' => array('group' => 'automobil-icons'),
					'icon icon-request_quote' => array('group' => 'automobil-icons'),
					'icon icon-solution' => array('group' => 'automobil-icons'),
					'icon icon-star' => array('group' => 'automobil-icons'),
					'icon icon-steering' => array('group' => 'automobil-icons'),
					'icon icon-tag' => array('group' => 'automobil-icons'),
					'icon icon-services_icon_1' => array('group' => 'automobil-icons'),
					'icon icon-services_icon_2' => array('group' => 'automobil-icons'),
					'icon icon-services_icon_3' => array('group' => 'automobil-icons'),
					'icon icon-services_icon_4' => array('group' => 'automobil-icons'),
					'icon icon-services_icon_5' => array('group' => 'automobil-icons'),
					'icon icon-services_icon_6' => array('group' => 'automobil-icons'),
				),
			),
		);
	}
